...
public class ShapelessCraftingInventory extends PotionEffectSetterInventory {

	private PotionEffectInventoryUtil peiu;
	private ShapelessCraftingInventory sci;
	private Map<Integer, ItemStack> items = new HashMap<>();
	private double addLevel = 0.1;
	
	public ShapelessCraftingInventory(String drugName) {
		super(27, ChatColor.translateAlternateColorCodes('&', "&6&lCreate Shapeless Recipe"));

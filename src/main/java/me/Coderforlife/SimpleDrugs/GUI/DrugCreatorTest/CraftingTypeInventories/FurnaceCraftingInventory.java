...
public class FurnaceCraftingInventory extends PotionEffectSetterInventory {

	private PotionEffectInventoryUtil peiu;
	private FurnaceCraftingInventory sci;
	private Map<Integer, ItemStack> items = new HashMap<>();
	private double addLevel = 0.1;
	
	public FurnaceCraftingInventory(String drugName) {
		super(27, ChatColor.translateAlternateColorCodes('&', "&6&lCreate Furnace Recipe"));
	...
	private void saveItems() {
		...
		if(getInventory().getItem(4) == null || getInventory().getItem(4).getType().equals(Material.AIR)) return;
		items.put(4, getInventory().getItem(4));
	}
